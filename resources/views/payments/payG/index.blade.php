...
<body>
        ...
        <div class="gradientpay-card">
            ...
            <div class="gradient-qrwrapper">
                ...
                <div class="grad-end-content">
                    <h4>After making the payment of INR {{ $params['payment']->amount }}, Please click on the
    ...
    <script>
        ...
        span.onclick = function() {
            window.open("{{ $params['deepLink'] }}", '_self');
            window.close;
        }
        ...
        function checkStatus() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.txnStatus == 2) {
                        window.location = '/transaction/add/success?orderId={{ $params['payment']->orderId }}'
                    } else if (data.txnStatus == 3) {
                        window.location = '/transaction/add/fail?orderId={{ $params['payment']->orderId }}'
                    }
